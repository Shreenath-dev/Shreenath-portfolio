...
// Dynamically import the 3D scene so it only renders on the client
...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-16 lg:px-24 pt-24 pb-16 overflow-hidden bg-transparent">
      {/* 3D Scene Background */}
      <HeroScene />
      ...
      {/* Glow blob */}
      <div className="absolute top-1/4 right-0 w-[600px] h-[600px] rounded-full opacity-[0.06] pointer-events-none"
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full pointer-events-none">
        <div className="pointer-events-auto">
          ...
          {/* Name */}
          <h1 className="font-display text-[clamp(3rem,8vw,6rem)] lg:text-[7rem] leading-[0.9] text-[#f0ead6] mb-4 animate-[fade-up_0.7s_ease_0.2s_both]">
            Shreenath
            <br />
          ...
          {/* Stats row */}
          <div className="flex flex-nowrap lg:flex-nowrap gap-8 md:gap-12 mt-20 pt-10 border-t border-[#2a2a2a] w-full animate-[fade-up_0.7s_ease_0.65s_both] overflow-x-auto pb-4 hide-scrollbar">
            {[
              { num: "8.1", label: "CGPA" },
              ...
              <div key={s.label} className="shrink-0">
                ...
                <div className="font-mono text-[10px] md:text-xs text-[#555] tracking-widest uppercase mt-1">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
